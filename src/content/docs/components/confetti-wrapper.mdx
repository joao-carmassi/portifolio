...
description: "A wrapper component that triggers a canvas-confetti celebration animation on any child button click."
---
...
import Demo1 from '@/prisma/demos/confetti-wrapper/1';
import Demo2 from '@/prisma/demos/confetti-wrapper/2';
import Demo3 from '@/prisma/demos/confetti-wrapper/3';
import Demo4 from '@/prisma/demos/confetti-wrapper/4';
...
<Install registryUrl='/components/confetti-wrapper.json' />
...
<ComponentPreview>
  <ConfettiOnClickDemo client:visible />
</ComponentPreview>
