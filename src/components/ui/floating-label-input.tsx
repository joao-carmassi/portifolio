...
function FloatingLabelText({
  ...
  return (
    <Label
      className={cn(
        'absolute inset-s-2 top-0.5 z-10 origin-left -translate-y-3 translate-x-2 scale-75 transform bg-card px-2 text-sm text-muted-foreground duration-300',
        ...
        'peer-focus:top-0.5 peer-focus:-translate-y-3 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-foreground peer-focus:translate-x-2',
        'cursor-text',
        className,
      )}
      {...props}
