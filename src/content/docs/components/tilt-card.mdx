...
| `...img props`        | `Omit<ComponentProps<'img'>, 'src' \| 'alt' \| 'className'>` | —       | Forwarded to the `<img>` (`loading`, `sizes`, `decoding`, etc.). |

### Using image props

You can pass regular `<img>` props directly to `DepthMedia`.
