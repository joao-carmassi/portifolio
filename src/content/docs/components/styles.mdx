---
title: "Styles & Themes"
description: "Install Prisma UI components matched to your shadcn style. Register the @prisma namespace once and the shadcn CLI resolves the right Button and Badge scale for radix-vega, radix-nova, radix-maia, radix-lyra, radix-mira, radix-luma, radix-rhea, and radix-sera."
---

import { Code } from '@astrojs/starlight/components';
import { PUBLIC_SITE_URL } from 'astro:env/client';
import Install from '@/prisma/docs/Install.astro';
import RegistryConfig from '@/prisma/docs/RegistryConfig.astro';
...
<Code code={`${PUBLIC_SITE_URL}/components/radix-nova/button.json`} />
...
<Code lang="bash" code={`npx shadcn@latest add ${PUBLIC_SITE_URL}/components/radix-nova/button.json`} />
