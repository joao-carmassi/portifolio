...
// uses the site's Geist Mono (Astro fonts API) instead of loading every JetBrains Mono weight/subset (~96 requests)
...
const MONO_FAMILY = "var(--font-geist-mono), ui-monospace, monospace";
