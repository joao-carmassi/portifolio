---
title: "Installation"
description: "Install Prisma UI components via the shadcn CLI. An advanced React component library built on Radix UI and Tailwind CSS."
---
...
The `{style}` placeholder is replaced by the CLI with the `style` field already present in your `components.json`, so every component arrives sized and shaped for your theme. See [Styles & Themes](/components/styles/) for the supported styles and the details.
